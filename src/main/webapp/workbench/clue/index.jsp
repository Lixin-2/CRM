		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data.dataList,function (i,n) {
					...
					html+='	<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'workbench/clue/selectClueById.do?id='+n.id+'\';">'+n.fullname+n.appellation+'</a></td>'
